$(document).ready(function(){
	...
	$("#searchForm").on('keyup', function(event){
		if(firstTime){
			...
			$("#typeNew option[value="+type+"]").prop('selected',true); //keep lang selected
			//set cursor at end of field so can continue typing
			var searchFieldNew = $(".searchFieldNew");
			searchFieldNew.val(searchFieldVal);
